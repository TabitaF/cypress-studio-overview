export const buzzPageElements ={
    buzzMenuButton: ':nth-child(12) > .oxd-main-menu-item',
    mindPostBox:'.oxd-buzz-post-input',
    ...
    likeComment:'.orangehrm-post-comment-action-area > :nth-child(1)',
    editComment:'.orangehrm-post-comment-action-area > :nth-child(2)',
    deleteComment:'.orangehrm-post-comment-action-area > :nth-child(3)',
    likedList:':nth-child(1) > .oxd-sheet > .orangehrm-buzz-post-footer > .orangehrm-buzz-stats > :nth-child(1) > .oxd-text',
    commentList:':nth-child(1) > .oxd-sheet > .orangehrm-buzz-post-footer > .orangehrm-buzz-stats > :nth-child(2) > .oxd-text',
    sharedList:':nth-child(1) > .oxd-sheet > .orangehrm-buzz-post-footer > .orangehrm-buzz-stats > :nth-child(2) > .oxd-text',
    closeDetails:'.orangehrm-photo-viewer > .oxd-icon-button > .oxd-icon',
    likedDetailsPicture:'.orangehrm-post-details-actions > .orangehrm-like-animation',
    likeListInDetails:'.orangehrm-post-details-actions > .orangehrm-buzz-stats > :nth-child(1) > .oxd-text',
    employeeInsideLikedList:'.orangehrm-buzz-stats-modal-employee',
    addPhotoPost:'.oxd-file-div',
    sharePhotoButton:'.oxd-form-actions > .oxd-button',
 ...
 * abrir comentarios
 * lista de shares
 * hacer comentario en un post
 * dar me gusta a comentario
 * editar comentario
 * borrar comentario
 * abrir detalles de post con foto
 * 
*/